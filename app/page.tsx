...
const basePath = '/core-tech-1776052702968';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our hosting services provide secure, reliable, and high-performance solutions for businesses and individuals looking to establish a strong online presence, with features such as scalable storage, robust security, and 24/7 support. Our hosting plans are designed to meet the unique needs of each client, ensuring maximum uptime and optimal performance.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our web development services cater to businesses and individuals seeking to create custom websites, e-commerce platforms, and web applications that are visually appealing, user-friendly, and optimized for search engines. Our team of expert developers works closely with clients to understand their requirements and deliver bespoke solutions that meet their goals and objectives.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our app development services enable businesses and individuals to create mobile applications that are engaging, interactive, and tailored to their specific needs, with features such as user-friendly interfaces, secure data storage, and seamless integration with existing systems. We develop apps for both iOS and Android platforms, ensuring that our clients can reach a wide audience.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our domain registration services provide a convenient and secure way for businesses and individuals to register and manage their domain names, with features such as competitive pricing, easy domain management, and 24/7 support. We offer a range of domain extensions and registration options to suit different needs and budgets.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our inquiries service allows potential clients to get in touch with us and receive personalized advice and guidance on our range of technology solutions, with a dedicated team of experts available to answer questions, provide quotes, and discuss custom projects and requirements.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Core Tech is a leading technology solutions provider based in Kuching, dedicated to delivering innovative and customer-centric services to businesses and individuals alike. With a strong focus on web development, hosting, and application development, we strive to provide the best tech solutions that cater to the evolving needs of our clients. Our team of experts is committed to ensuring that our services are always reliable, efficient, and secure.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the premier technology solutions provider in Kuching, renowned for our exceptional service quality, innovative approach, and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide cutting-edge technology solutions that empower businesses and individuals to achieve their goals, while fostering a culture of innovation, customer focus, and excellence.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">At Core Tech, we prioritize our customers\' needs above all else, ensuring that our services are tailored to meet their unique requirements and expectations.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We embrace innovation as a core driver of our business, continuously seeking new and improved ways to leverage technology and deliver value to our clients.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/6804612/pexels-photo-6804612.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/270373/pexels-photo-270373.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/9431454/pexels-photo-9431454.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
